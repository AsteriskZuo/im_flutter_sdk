...
- (void)handleMethodCall:(FlutterMethodCall*)call result:(FlutterResult)result {
    if ([ExtSdkMethodKeyJoinChatRoom isEqualToString:call.method])
    {
        [self joinChatroom:call.arguments result:result];
    }
    else if ([ExtSdkMethodKeyLeaveChatRoom isEqualToString:call.method]) {
        [self leaveChatroom:call.arguments result:result];
    }
    else if ([ExtSdkMethodKeyGetChatroomsFromServer isEqualToString:call.method]) {
        [self getChatroomsFromServer:call.arguments result:result];
    }
    else if ([ExtSdkMethodKeyCreateChatRoom isEqualToString:call.method]) {
        [self createChatroom:call.arguments result:result];
    }
    else if ([ExtSdkMethodKeyDestroyChatRoom isEqualToString:call.method]) {
        [self destroyChatRoom:call.arguments result:result];
    }
    else if ([ExtSdkMethodKeyFetchChatRoomFromServer isEqualToString:call.method]) {
        [self fetchChatroomInfoFromServer:call.arguments result:result];
    }
    else if ([ExtSdkMethodKeyGetChatRoom isEqualToString:call.method]) {
        [self getChatroom:call.arguments result:result];
    }
    else if ([ExtSdkMethodKeyGetAllChatRooms isEqualToString:call.method]) {
        [self getAllChatrooms:call.arguments result:result];
    }
    else if ([ExtSdkMethodKeyGetChatroomMemberListFromServer isEqualToString:call.method]) {
        [self getChatroomMemberListFromServer:call.arguments result:result];
    }
    else if ([ExtSdkMethodKeyFetchChatroomBlockListFromServer isEqualToString:call.method]) {
        [self fetchChatroomBlockListFromServer:call.arguments result:result];
    }
    else if ([ExtSdkMethodKeyGetChatroomMuteListFromServer isEqualToString:call.method]) {
        [self getChatroomMuteListFromServer:call.arguments result:result];
    }
    else if ([ExtSdkMethodKeyFetchChatroomAnnouncement isEqualToString:call.method]) {
        [self fetchChatroomAnnouncement:call.arguments result:result];
    }
    else if ([ExtSdkMethodKeyChatRoomUpdateSubject isEqualToString:call.method]) {
        [self chatRoomUpdateSubject:call.arguments result:result];
    }
    else if ([ExtSdkMethodKeyChatRoomUpdateDescription isEqualToString:call.method]) {
        [self chatRoomUpdateDescription:call.arguments result:result];
    }
    else if ([ExtSdkMethodKeyChatRoomRemoveMembers isEqualToString:call.method]) {
        [self chatRoomRemoveMembers:call.arguments result:result];
    }
    else if ([ExtSdkMethodKeyChatRoomBlockMembers isEqualToString:call.method]) {
        [self chatRoomBlockMembers:call.arguments result:result];
    }
    else if ([ExtSdkMethodKeyChatRoomUnblockMembers isEqualToString:call.method]) {
        [self chatRoomUnblockMembers:call.arguments result:result];
    }
    else if ([ExtSdkMethodKeyChangeChatRoomOwner isEqualToString:call.method]) {
        [self chatRoomChangeOwner:call.arguments result:result];
    }
    else if ([ExtSdkMethodKeyChatRoomAddAdmin isEqualToString:call.method]) {
        [self chatRoomAddAdmin:call.arguments result:result];
    }
    else if ([ExtSdkMethodKeyChatRoomRemoveAdmin isEqualToString:call.method]) {
        [self chatRoomRemoveAdmin:call.arguments result:result];
    }
    else if ([ExtSdkMethodKeyChatRoomMuteMembers isEqualToString:call.method]) {
        [self chatRoomMuteMembers:call.arguments result:result];
    }
    else if ([ExtSdkMethodKeyChatRoomUnmuteMembers isEqualToString:call.method]) {
        [self chatRoomUnmuteMembers:call.arguments result:result];
    }
    else if ([ExtSdkMethodKeyUpdateChatRoomAnnouncement isEqualToString:call.method]) {
        [self updateChatroomAnnouncement:call.arguments result:result];
    }
    else if ([ExtSdkMethodKeyAddMembersToChatRoomWhiteList isEqualToString:call.method]) {
        [self addMembersToChatRoomWhiteList:call.arguments result:result];
    }
    else if ([ExtSdkMethodKeyRemoveMembersFromChatRoomWhiteList isEqualToString:call.method]) {
        [self removeMembersFromChatRoomWhiteList:call.arguments result:result];
    }
    else if ([ExtSdkMethodKeyFetchChatRoomWhiteListFromServer isEqualToString:call.method]) {
        [self fetchChatRoomWhiteListFromServer:call.arguments result:result];
    }
    else if ([ExtSdkMethodKeyIsMemberInChatRoomWhiteListFromServer isEqualToString:call.method]) {
        [self isMemberInChatRoomWhiteListFromServer:call.arguments result:result];
    }
    else if ([ExtSdkMethodKeyMuteAllChatRoomMembers isEqualToString:call.method]) {
        [self muteAllChatRoomMembers:call.arguments result:result];
    }
    else if ([ExtSdkMethodKeyUnMuteAllChatRoomMembers isEqualToString:call.method]) {
    ...
    [EMClient.sharedClient.roomManager getChatroomsFromServerWithPage:page
                                                           ...
                                                           completion:^(EMPageResult *aResult, EMError *aError)
     {
        [weakSelf wrapperCallBack:result
                      channelName:ExtSdkMethodKeyGetChatroomsFromServer
                            error:aError
...
- (void)createChatroom:(NSDictionary *)param result:(FlutterResult)result {
    ...
    [EMClient.sharedClient.roomManager createChatroomWithSubject:subject
     ...
     {
        [weakSelf wrapperCallBack:result
                      channelName:ExtSdkMethodKeyCreateChatRoom
                            error:aError
...
- (void)joinChatroom:(NSDictionary *)param result:(FlutterResult)result {
    ...
    [EMClient.sharedClient.roomManager joinChatroom:chatroomId
     ...
     {
        [weakSelf wrapperCallBack:result
                      channelName:ExtSdkMethodKeyJoinChatRoom
                            error:aError
                           object:@(!!aChatroom)];
    }];
}
...
- (void)leaveChatroom:(NSDictionary *)param result:(FlutterResult)result {
    ...
    [EMClient.sharedClient.roomManager leaveChatroom:chatroomId
     ...
     {
        [weakSelf wrapperCallBack:result
                      channelName:ExtSdkMethodKeyLeaveChatRoom
                            error:aError
                           object:nil];
    }];
}
...
- (void)destroyChatRoom:(NSDictionary *)param result:(FlutterResult)result {
    ...
    [EMClient.sharedClient.roomManager destroyChatroom:chatroomId completion:^(EMError *aError) {
        [weakSelf wrapperCallBack:result
                      channelName:ExtSdkMethodKeyDestroyChatRoom
                            error:aError
                           object:nil];
    }];
}
...
- (void)fetchChatroomInfoFromServer:(NSDictionary *)param result:(FlutterResult)result {
    ...
    {
        [weakSelf wrapperCallBack:result
                      channelName:ExtSdkMethodKeyFetchChatRoomFromServer
                            error:aError
                           object:[aChatroom toJson]];
...
- (void)getChatroom:(NSDictionary *)param result:(FlutterResult)result {
    ...
    [weakSelf wrapperCallBack:result
                  channelName:ExtSdkMethodKeyGetChatRoom
                        error:nil
...
- (void)getAllChatrooms:(NSDictionary *)param result:(FlutterResult)result {
    ...
    [EMClient.sharedClient.roomManager getChatroomsFromServerWithPage:0
                                                           ...
                                                           completion:^(EMPageResult *aResult, EMError *aError)
     {
        ...
        [weakSelf wrapperCallBack:result
                      channelName:ExtSdkMethodKeyGetAllChatRooms
                            error:aError
                           object:list];
    }];
}
...
- (void)getChatroomMemberListFromServer:(NSDictionary *)param result:(FlutterResult)result {
    ...
    [EMClient.sharedClient.roomManager getChatroomMemberListFromServerWithId:chatroomId
     ...
     {
        [weakSelf wrapperCallBack:result
                      channelName:ExtSdkMethodKeyGetChatroomMemberListFromServer
                            error:aError
                           object:[aResult toJson]];
...
- (void)fetchChatroomBlockListFromServer:(NSDictionary *)param result:(FlutterResult)result {
    ...
    {
        [weakSelf wrapperCallBack:result
                      channelName:ExtSdkMethodKeyFetchChatroomBlockListFromServer
                            error:aError
                           object:aList];
    }];
}
...
- (void)getChatroomMuteListFromServer:(NSDictionary *)param result:(FlutterResult)result {
    ...
    {
        [weakSelf wrapperCallBack:result
                      channelName:ExtSdkMethodKeyGetChatroomMuteListFromServer
                            error:aError
                           object:aList];
    }];
}
...
- (void)fetchChatroomAnnouncement:(NSDictionary *)param result:(FlutterResult)result {
    ...
    {
        [weakSelf wrapperCallBack:result
                      channelName:ExtSdkMethodKeyFetchChatroomAnnouncement
                            error:aError
...
- (void)chatRoomUpdateSubject:(NSDictionary *)param result:(FlutterResult)result {
                                          ...
                                          completion:^(EMChatroom *aChatroom, EMError *aError)
    {
        ...
        [weakSelf wrapperCallBack:result
                      channelName:ExtSdkMethodKeyChatRoomUpdateSubject
                            error:aError
                           object:nil];
    }];
}
...
- (void)chatRoomUpdateDescription:(NSDictionary *)param result:(FlutterResult)result {
    ...
    {
        [weakSelf wrapperCallBack:result
                      channelName:ExtSdkMethodKeyChatRoomUpdateDescription
                            error:aError
                           object:nil];
    }];
}
...
- (void)chatRoomRemoveMembers:(NSDictionary *)param result:(FlutterResult)result {
    ...
    {
        [weakSelf wrapperCallBack:result
                      channelName:ExtSdkMethodKeyChatRoomRemoveMembers
                            error:aError
                           object:nil];
    }];
}
...
- (void)chatRoomBlockMembers:(NSDictionary *)param result:(FlutterResult)result {
    ...
    {
        [weakSelf wrapperCallBack:result
                      channelName:ExtSdkMethodKeyChatRoomBlockMembers
                            error:aError
                           object:nil];
    }];
}
...
- (void)chatRoomUnblockMembers:(NSDictionary *)param result:(FlutterResult)result {
    ...
    {
        [weakSelf wrapperCallBack:result
                      channelName:ExtSdkMethodKeyChatRoomUnblockMembers
                            error:aError
                           object:nil];
    }];
}
...
- (void)chatRoomChangeOwner:(NSDictionary *)param result:(FlutterResult)result {
    ...
    {
        [weakSelf wrapperCallBack:result
                      channelName:ExtSdkMethodKeyChangeChatRoomOwner
                            error:aError
                           object:nil];
    }];
}
...
- (void)chatRoomAddAdmin:(NSDictionary *)param result:(FlutterResult)result {
    ...
    {
        [weakSelf wrapperCallBack:result
                      channelName:ExtSdkMethodKeyChatRoomAddAdmin
                            error:aError
                           object:nil];
    }];
}
...
- (void)chatRoomRemoveAdmin:(NSDictionary *)param result:(FlutterResult)result {
    ...
    {
        [weakSelf wrapperCallBack:result
                      channelName:ExtSdkMethodKeyChatRoomRemoveAdmin
                            error:aError
                           object:nil];
    }];
}
...
- (void)chatRoomMuteMembers:(NSDictionary *)param result:(FlutterResult)result {
    ...
    {
        [weakSelf wrapperCallBack:result
                      channelName:ExtSdkMethodKeyChatRoomMuteMembers
                            error:aError
                           object:nil];
    }];
}
...
- (void)chatRoomUnmuteMembers:(NSDictionary *)param result:(FlutterResult)result {
    ...
    {
        [weakSelf wrapperCallBack:result
                      channelName:ExtSdkMethodKeyChatRoomUnmuteMembers
                            error:aError
                           object:nil];
    }];
}
...
- (void)updateChatroomAnnouncement:(NSDictionary *)param result:(FlutterResult)result {
    ...
    {
        [weakSelf wrapperCallBack:result
                      channelName:ExtSdkMethodKeyUpdateChatRoomAnnouncement
                            error:aError
                           object:@(!aError)];
    }];
}
...
#pragma mark - ExtSdkChatroomManagerWrapper
...
- (void)userDidJoinChatroom:(EMChatroom *)aChatroom
    ...
    [self.channel invokeMethod:ExtSdkMethodKeyChatroomChanged
                     arguments:map];
